  ...
  function Tabs() {
    ...
    return (
      (_ret = ((_temp = ((_this = (0, _possibleConstructorReturn3.default)(
        this,
        (_ref =
          Tabs.__proto__ || (0, _getPrototypeOf2.default)(Tabs)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
  ...
  (0, _createClass3.default)(Tabs, [
        ...
        this.setState({
          selectedIndex:
            valueLink.value !== undefined
              ...
              : initialIndex < this.getTabCount() ? initialIndex : 0
        });
      }
    },
    {
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (_props.inkBarStyle && _props.inkBarStyle.width) {
          width = 100 / Number(_props.inkBarStyle.width.replace("%", ""));
        }
        ...
        var tabs = this.getTabs().map(function(tab, index) {
          ...
          process.env.NODE_ENV !== "production"
            ? (0, _warning2.default)(
                ...
                "Material-UI: Tabs value prop has been passed, but Tab " +
                  index +
        ...
        var realSelectedIndex = valueLink.value
          ? this.getSelectedIndex(this.props)
